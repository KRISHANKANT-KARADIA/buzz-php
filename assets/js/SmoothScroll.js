...
(function () {
    ...
    function init() {
        ...
        var php = document.documentElement;
        var windowHeight = window.innerHeight;
        var scrollHeight = body.scrollHeight;

        // check compat mode for root element
        root = (document.compatMode.indexOf('CSS') >= 0) ? php : body;
        activeElement = body;
         ...
         * on some pages. e.g.: php, body { height: 100% }
         */
        else if (isOldSafari &&
            scrollHeight > windowHeight &&
            (body.offsetHeight <= windowHeight ||
                php.offsetHeight <= windowHeight)) {
        ...
        if (!options.fixedBackground && !isExcluded) {
            ...
            php.style.backgroundAttachment = 'scroll';
        }
    }
        ...
        if (document.URL.indexOf('www.youtube.com/watch') != -1) {
            do {
                isControl = (elem.classList &&
                    elem.classList.contains('php5-video-controls'));
                if (isControl) break;
